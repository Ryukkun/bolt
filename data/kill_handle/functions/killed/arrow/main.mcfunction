...
execute unless score @s kh_killedby = @s gm_id at @a[team=!spectator] if score @p[team=!spectator] gm_id = @s kh_killedby run function kill_handle:killed/arrow/other
