...
execute as @e[type=area_effect_cloud,tag=kh_arrow,tag=kh_tracer] at @e[type=arrow,tag=setup,distance=..5] if score @e[type=arrow,tag=setup,distance=0,limit=1] kh_arrowId = @s kh_arrowId run tp ~ ~ ~
#kill traces
