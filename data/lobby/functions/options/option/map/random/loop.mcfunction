...
kill @e[type=area_effect_cloud,tag=rnd_num_generator]
...
# ブラックリスト
execute unless score gameMode cm_main matches 2 if score random_map cm_miscellaneous matches 6 run function lobby:options/option/map/random/loop