...
execute at @e[type=area_effect_cloud,tag=marker,tag=option,tag=option_points_to_win] run setblock ~ ~ ~ oak_wall_sign[facing=west]{front_text:{messages:['{"text":"Flag Captures","color":"aqua"}','{"text":"to win","color":"aqua"}','""','""']}} destroy
