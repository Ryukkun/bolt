...
tellraw @s ["",{"text":"You finished that section in ","color":"gold"},{"score":{"name":"mins_split","objective":"pk_math"},"color":"green"},{"text":" Minutes, ","color":"gold"},{"score":{"name":"secs_split","objective":"pk_math"},"color":"green"},{"text":"."},{"score":{"name":"ms_split_0","objective":"pk_math"},"color":"green"},{"score":{"name":"ms_split","objective":"pk_math"},"color":"green"},{"text":" Seconds","color":"gold"}]
