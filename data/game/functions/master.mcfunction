...
item replace entity @a[gamemode=adventure,tag=!frozen,scores={gm_inGame=1},nbt=!{Inventory:[{Slot:0b,id:"minecraft:bow",Count:1b}]}] container.0 with bow{Unbreakable:1b}
