...
execute if score @s[tag=blaze_powder] item_cooldown matches 15 run function game:freeze_tag/item/anti_freeze
execute if score @s[tag=ice] item_cooldown matches 15 run function game:freeze_tag/item/refreeze
