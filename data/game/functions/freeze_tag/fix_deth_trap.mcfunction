...
execute if score @s fox_x1_arrow = @s fox_x2_arrow if score @s fox_z1_arrow = @s fox_z2_arrow positioned ~ ~-2 ~ if entity @e[distance=..1,type=armor_stand,tag=freeze] run tag @s add fox_pause
