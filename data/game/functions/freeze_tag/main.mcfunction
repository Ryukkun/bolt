...
# team functions
item replace entity @a[team=1blue, tag=!frozen] hotbar.1 with minecraft:blaze_powder{keepitem:1b,FreezeTagItem:1b,display:{Name:'{"text":"Anti-Freeze","color":"blue","italic":false}',Lore:['{"text":"Don\'t eat!","color":"dark_aqua"}','{"text":"Use on a frozen teammate to defrost","color":"dark_aqua"}','{"text":""}','{"text":"Drop to use","color":"gray"}']}}
item replace entity @a[team=1blue, tag=!frozen] hotbar.2 with minecraft:ice{keepitem:1b,FreezeTagItem:1b,display:{Name:'{"text":"Refreeze","color":"blue","italic":false}',Lore:['{"text":"Use to put out a fire below an enemy!","color":"dark_aqua"}','{"text":""}','{"text":"Drop to use","color":"gray"}']}}

item replace entity @a[team=3red,tag=!frozen] hotbar.1 with minecraft:blaze_powder{keepitem:1b,FreezeTagItem:1b,display:{Name:'{"text":"Anti-Freeze","color":"red","italic":false}',Lore:['{"text":"Don\'t eat!","color":"dark_aqua"}','{"text":"Use on a frozen teammate to defrost","color":"dark_aqua"}','{"text":""}','{"text":"Drop to use","color":"gray"}']}}
item replace entity @a[team=3red,tag=!frozen] hotbar.2 with minecraft:ice{keepitem:1b,FreezeTagItem:1b,display:{Name:'{"text":"Refreeze","color":"red","italic":false}',Lore:['{"text":"Use to put out a fire below an enemy!","color":"dark_aqua"}','{"text":""}','{"text":"Drop to use","color":"gray"}']}}
