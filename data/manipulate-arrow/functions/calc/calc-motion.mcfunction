...
## y
execute store result score $in Ryukkun_temp run data get entity @p[tag=Ryu.MArrow._,distance=..0] Rotation[1] 100
...
## x
execute store result score $in Ryukkun_temp run data get entity @p[tag=Ryu.MArrow._,distance=..0] Rotation[0] 100
function manipulate-arrow:calc/sin/
